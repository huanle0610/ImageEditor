Ext.define('ImageEditorApp.view.image.IntersectionsComponent1', {
    extend: 'Ext.draw.Component',
    xtype: 'intersections-component1',
    ...
    findTarget: function (sprites, x, y) {
        ...
        for (i = 0, ln = sprites.length; i < ln; i++) {
            ...
            //console.log(x, y, sprites[0].isPointInPath(x, y));
            if ((sprite.isPath && sprite.isPointInPath(x, y))) {
            //if ((sprite.type == 'image' && sprite.isPointInPath(x, y)) || (sprite.isPath && sprite.isPointInPath(x, y))) {
                me.target = sprite;
                return sprite;
            }
        }
